    ...
    <section class="orders">
         ...
         <div class="box-container">
             <?php
              ...
              ?>
              <div class="box" <?php if($fetch_order['status']=='canceled') { echo 'style="border: 2px solid red";'; }else{ echo 'style="border: 2px solid blue";'; } ?>>
                  <a href="view_order.php?get_id=<?= $fetch_order['id']; ?>">
                      ...
                      <div class="row">
                          ...
                          <p class="status" style="color:<?php if($fetch_order['status']== 'delivered'){ echo 'green'; }elseif($fetch_order['status']=='canceled'){ echo 'red'; }elseif($fetch_order['status']=='pending') { echo 'green'; }else{ echo 'orange';} ?>"></p>
                       </div>
                       </a>
                   </div>
                   <?php
