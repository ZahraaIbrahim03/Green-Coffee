    ...
    <section class="order-detail">
         ...
         <div class="box">
            ...
            <div class="col">
                ...
                <p class="status" style="color:<?php if ($fetch_order['status']=='delevered') { echo 'green'; }elseif($fetch_order['status'] == 'canceled') { echo 'red'; }elseif($fetch_order['status'] == 'pending') { echo 'blue'; }else{ echo orange; } ?>"><?=$fetch_order['status'] ?></p>
